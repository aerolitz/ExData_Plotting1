...
##                              intensity (in ampere)
## 7 - Sub_metering_1:          energy sub-metering No. 1 (in watt-hour
##                              of active energy). It corresponds to the
##                              kitchen, containing mainly a dishwasher,
##                              an oven and a microwave (hot plates are
##                              not electric but gas powered).
## 8 - Sub_metering_2:          energy sub-metering No. 2 (in watt-hour
##                              of active energy). It corresponds to the
##                              laundry room, containing a
##                              washing-machine, a tumble-drier, a 
##                              refrigerator and a light.
## 9 - Sub_metering_3:          energy sub-metering No. 3 (in watt-hour
##                              of active energy). It corresponds to an
##                              electric water-heater and an 
##                              air-conditioner.
...
##      for reading the data so that the plot can be fully reproduced.
...
## Setting up the Working directory and File
setwd("~/R/exdata-013/project1/")
arquivo <- "~/R/exdata-013/project1/household_power_consumption.txt"
dt <- data.table(read.table(arquivo, header=TRUE, sep=";", stringsAsFactors=FALSE, dec=".", na = "?"))

## We will only be using data from the dates 2007-02-01 and 2007-02-02
periodo <- dt[dt$Date %in% c("1/2/2007","2/2/2007") ,]